    ...
    <div className="p-6 max-w-5xl mx-auto">
      ...
      {loading ? (
        ...
        <div className="text-center py-20 bg-white rounded-xl border border-dashed border-gray-300">
          ...
          <p className="text-gray-400 text-xs mt-1">Click "Add Agent" to get started.</p>
        </div>
      ) : (
            ...
            >
              ...
              <div className="flex justify-end">
                <button
                  ...
                  className="text-red-400 hover:text-red-600 disabled:opacity-40 p-1.5 rounded-lg hover:bg-red-50"
                  title="Remove agent"
                >
